...
namespace InputPhones
{
    ...
    public partial class Form3 : CCSkinMain
    {
        ...
        string style = @"<style>.left_ph {margin: 30px auto 0;overflow: hidden; text-align: center;width: 600px; }.left_name {    color: #666666;    font-size: 13px;    font-weight: 700; dding-bottom: 20px;    padding-right: 10px;    text-align: right;
}</style>";
